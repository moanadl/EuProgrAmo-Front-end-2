function carregaDicionario() {
    ...
    var biografias = [
        {
            ...
            imagem: 'images/marielle-franco.png',
        ...
        {
            nome: 'Lélia Gonzalez',
            imagem: 'images/lelia-gonzalez.png',
        ...
        {
            nome: 'Angela Davis',
            imagem: 'images/angela-davis.png',
        ...
        },
        {
            ...
            imagem: 'images/conceicao-evaristo.png',
        ...
        },
        {
            ...
            imagem: 'images/carolina-de-jesus.png',
    ...
    const content = document.getElementById('cards-women');

    for (let bio in biografias) {
        content.innerHTML += '<div class="card">' + // Usa esse += pra ir "somando", se não no fim vai ficar só o último objeto
